...
function Chat() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true); 
    try {
      const res = await axios.post('https://tasty-gown-lion.cyclic.app/genrateresponse', { question });
      setChatHistory(prevChatHistory => [...prevChatHistory, { message: question, sender: 'user' }, { message: res.data.chatbot_response, sender: 'bot' }]);
    } catch (error) {
